...
export const Button: React.FC<ButtonProps> = ({ 
    ...
    children, 
    className, 
    type = 'button', // ✅ Default value for button type
    ...props 
}) => {
    ...
    switch (variant) {
        ...
        case 'secondary': variantStyle = 'bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-400'; break;
        case 'danger': variantStyle = 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500'; break;
        case 'warning': variantStyle = 'bg-yellow-500 text-white hover:bg-yellow-600 focus:ring-yellow-400'; break;
    }

    return (
        <button 
            type={type} // ✅ Correct usage
